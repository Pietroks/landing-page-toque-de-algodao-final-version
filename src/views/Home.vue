...
export default {
    ...
    data () {
      return {
        textoPersonalizado: 'Acesse minhas redes sociais:'
      }
    }
}
</script>
...
<style >
  main {
    display: flex;
    flex-direction: row;
    margin-top: 20px; /* Aumentando o espaço superior */
    margin-bottom: auto;
  ...
  .conteudo-principal {
    width: 45%; /* Reduzindo um pouco a largura para criar mais espaço entre os elementos */
  }
